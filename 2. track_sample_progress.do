...
* order
keep interviewers supervisor GHI_ISLAND_CODE PSU GHI_BLOCK_CODE
order interviewers supervisor GHI_ISLAND_CODE PSU GHI_BLOCK_CODE
...
preserve
collapse (sum) FILE1_STATUS FILE2_STATUS TUS_STATUS , by(GHI_ISLAND_CODE PSU interviewers)
