...
label define status 97 "Status Pending" 96 "In Progress" 95 "Invalid ID" 93 "Individual Refused" 94 "Individual Unavailable"  92 "Other", add
...
keep supervisor GHI_ISLAND_CODE PSU block HOUSEHOLD_KEY GHI_STRUCTURE PERSON_NAME PERSON_AGE PERSON_SEX
order supervisor GHI_ISLAND_CODE PSU block HOUSEHOLD_KEY GHI_STRUCTURE PERSON_NAME PERSON_AGE PERSON_SEX
