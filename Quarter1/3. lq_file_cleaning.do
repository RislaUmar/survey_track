...
merge 1:m LQ_ID ind_id using `lq_main_file', keepusing(status interview__key ind_nme)
...
gen completed_LQ =  completed_LQ_listing
...
duplicates drop LQ_ID ind__id , force
